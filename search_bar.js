...
function getVideo(json) {
    ...
    for (let i = 0; i < videoIDs.length; i++) {
        s = "https://www.youtube.com/embed/" + videoIDs[i];
        total += '<iframe width="250" height="200" src="' + s + '"></iframe>';
        // document.getElementById("list-videos").innerHTML +=
        // `<iframe width='640' height='390' src="https://www.youtube.com/embed/` + videoIDs[i] +
        //         `frameborder='0' allowFullScreen> </iframe>`;
    }
    document.getElementById("list-videos").innerHTML = total;
}